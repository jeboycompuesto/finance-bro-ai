...
Reviewed September 13, 2026, after the submission deadline. This is a repository and evidence review, not organizer confirmation of eligibility or an assertion that the portal entry is complete.
...
| Relevant license for public repository | Missing at initial review; requires the owner's license selection. |
...
| Portal submission and final URLs | Not verified. The official portal requires Google sign-in; final entry and submission receipt have not been inspected. |
| Team size at most three | Not independently verified. |
...
The [September 12 judging update](https://luma.com/blast/R0rguQyp0Q) also asks teams to form their team in the portal and make demo, GitHub and social links publicly viewable. Confirm the final URLs and any late-link acceptance with the organizer.
...
- Live browser check confirmed that lowering the scenario slider from $60k to $35k changes the reserve status to holding through Month 6.
